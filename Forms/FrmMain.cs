...
namespace QLNCKH
{
    public partial class FrmMain : Form {
        ...
        private void InitSidebar() {
            int top = 100;
            Dictionary<string, (Func<Form> func, string title)> forms = new Dictionary<string, (Func<Form> func, string title)> {
                ["Trang chủ"] = (() => new FrmHome(this), "HỆ THỐNG QUẢN LÝ NGHIÊN CỨU KHOA HỌC"),
